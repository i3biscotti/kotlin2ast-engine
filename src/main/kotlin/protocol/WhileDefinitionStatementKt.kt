...
@kotlin.jvm.JvmName("-initializewhileDefinitionStatement")
public inline fun whileDefinitionStatement(block: protocol.WhileDefinitionStatementKt.Dsl.() -> kotlin.Unit): protocol.Statements.WhileDefinitionStatement =
  protocol.WhileDefinitionStatementKt.Dsl._create(protocol.Statements.WhileDefinitionStatement.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `protocol.WhileDefinitionStatement`
 */
public object WhileDefinitionStatementKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: protocol.Statements.WhileDefinitionStatement.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: protocol.Statements.WhileDefinitionStatement.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): protocol.Statements.WhileDefinitionStatement = _builder.build()
    ...
    public val WhileDefinitionStatementKt.Dsl.positionOrNull: protocol.PositionOuterClass.Position?
      get() = _builder.positionOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun protocol.Statements.WhileDefinitionStatement.copy(block: `protocol`.WhileDefinitionStatementKt.Dsl.() -> kotlin.Unit): protocol.Statements.WhileDefinitionStatement =
  `protocol`.WhileDefinitionStatementKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val protocol.Statements.WhileDefinitionStatementOrBuilder.conditionOrNull: protocol.Expressions.Expression?
  get() = if (hasCondition()) getCondition() else null

public val protocol.Statements.WhileDefinitionStatementOrBuilder.positionOrNull: protocol.PositionOuterClass.Position?
